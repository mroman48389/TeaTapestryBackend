...
def main():
    ...
    print("ACCESS_TOKEN_ALGORITHM:", settings.access_token_algorithm)
    print("ACCESS_TOKEN_EXPIRES_IN:", settings.access_token_expires_in)
    print("REFRESH_TOKEN_SECRET:", settings.refresh_token_secret)
    print("REFRESH_TOKEN_ALGORITHM:", settings.refresh_token_algorithm)
