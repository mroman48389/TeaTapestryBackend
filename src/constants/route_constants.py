...
AUTH_DELETE_USER_DATA_PREFIX = f"{AUTH_PREFIX}/{DELETE_USER_DATA}"
AUTH_DELETE_USER_ACCOUNT_PREFIX = f"{AUTH_PREFIX}/{DELETE_USER_ACCOUNT}"
AUTH_CONFIRM_PASSWORD_PREFIX = f"{AUTH_PREFIX}/{CONFIRM_PASSWORD}"
