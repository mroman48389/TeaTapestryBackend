...
from src.core.compression import configure_gzip
from src.core.rate_limit.handlers_rate_limit import register_rate_limit_handlers
from src.core.rate_limit.config_rate_limit import HIGH_RATE_LIMIT
